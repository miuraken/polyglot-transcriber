...
```bash
python3 transcriber.py -i <input_audio_file> -o <output_text_file> -l <primary_lang,secondary_lang> [-t]
```
...
```
0.00 [en] This is Unit 1 of Pimsleur's Hindi.
3.42 [en] Listen to this Hindi conversation.
5.94 [hi] सुनिये, क्या आप अंग्रेजी समझती हैं? (suniye, kyā āpa aṃgrejī samajhatī haiṃ?)
9.12 [hi] जी नहीं, मैं अंग्रेजी नहीं समझती हूँ। (jī nahīṃ, maiṃ aṃgrejī nahīṃ samajhatī hū~|)
12.60 [hi] मैं थोड़ी थोड़ी हिंदी समझता हूँ। (maiṃ thor̤ī thor̤ī hiṃdī samajhatā hū~|)
15.12 [hi] क्या आप अमरीकी हैं? (kyā āpa amarīkī haiṃ?)
17.10 [en] Jee haan.
18.24 [en] In the next few minutes, you'll learn not only to understand this conversation,
23.43 [en] but to take part in it yourself.
25.71 [en] Imagine that an American man meets a
```
